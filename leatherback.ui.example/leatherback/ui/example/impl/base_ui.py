...
class BaseSample(object):
    def __init__(self) -> None:
        ...
        self._world_settings = {"physics_dt": 1.0 / 60.0, "stage_units_in_meters": 1.0, "rendering_dt": 1.0 / 60.0} # change
        # self._logging_info = ""
        return
    ...
    async def load_world_async(self):
        ...
        self.setup_scene()
        set_camera_view(eye=[1.5, 1.5, 1.5], target=[0.01, 0.01, 0.01], camera_prim_path="/OmniverseKit_Persp") # change
