"""
This will create a top Down camera similar to the one used to generate the Occupancy map
It will plot the top down image using:
    - matplotlib.pyplot

Doc references:
- IsaacSim camera sensors: https://docs.isaacsim.omniverse.nvidia.com/4.5.0/sensors/isaacsim_sensors_camera.html
- 
